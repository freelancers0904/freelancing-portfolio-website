...
const Hero = () => {
  ...
  return (
    <section className="hero-section relative flex min-h-[calc(100svh-68px)] items-center justify-center overflow-hidden md:min-h-screen md:items-center" style={{ background: 'hsl(var(--bg-primary))' }}>
      {/* Gold glow */}
