...
const features = [
  {
    ...
    violet: true,
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#6C63FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M14 9l-2-2-2 2"/></svg>,
  },
  {
    ...
    violet: false,
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#00D4AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>,
  },
  {
  ...
  },
  {
    ...
    violet: true,
    icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#6C63FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>,
  },
];
...
const AIFeatures = () => {
  ...
  return (
    <section className="py-28 md:py-32 relative overflow-hidden" style={{ background: '#080808' }}>
      ...
      <div ref={sectionRef} className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-16">
          {features.map((f, i) => (
            <div key={i} className="scroll-hidden glass-card p-8">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{
                background: f.violet ? 'rgba(108,99,255,0.1)' : 'rgba(0,212,170,0.08)',
                border: `1px solid ${f.violet ? 'rgba(108,99,255,0.2)' : 'rgba(0,212,170,0.15)'}`,
              }}>
                {f.icon}
              </div>
              <h3 className="font-display font-semibold text-lg text-agency-text mt-4">{f.title}</h3>
              <p className="font-body text-[15px] text-agency-text-secondary leading-[1.7] mt-2">{f.body}</p>
            </div>
          ))}
        </div>
